...
public class AgentChargeOrderController {
	...
	public String chargeOrderList(HttpServletRequest request, HttpSession session,
			...
			@RequestParam(value="rangeType",required=false)String rangeType) throws IOException{
		
		Example example = new Example(AgentChargeOrder.class,true,false);
		...
		List<AgentChargeOrder> listByPage = chargeOrderService.listAgentByExampleAndPage(example, pageNo);
		Page<AgentChargeOrder> page=(Page<AgentChargeOrder>) listByPage;
