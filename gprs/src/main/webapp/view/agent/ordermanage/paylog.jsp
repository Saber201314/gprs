...
<body>
	<fieldset class="layui-elem-field site-demo-button" style="margin-top: 5px;">
		<form class="layui-form" action="/agent/exportExcelPayLogDatas.action">
			<div class="layui-form-item">
				...
				<div  class="layui-inline">
					<div class="layui-input-block">
						...
						<button class="layui-btn" lay-submit="" lay-filter="excel-submit">导出Excel</button>
					</div>
				</div>
...
<script type="text/javascript">
	layui.config({
		...
		paylog: 'agent/ordermanage/paylog' //如果test.js是在根目录，也可以不用设定别名
	}).use('paylog'); //加载入口
