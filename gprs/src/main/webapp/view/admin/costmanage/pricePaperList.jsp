...
<body>
	...
	<a href="/view/admin/costmanage/addPricePaper.jsp"><button class="layui-btn layui-btn-mini">添加报价</button> </a>
...
<script type="text/javascript">
	layui.config({
		...
		pricePaperList: 'admin/costmanage/pricePaperList' //设定别名
	}).use('pricePaperList'); //加载入口
