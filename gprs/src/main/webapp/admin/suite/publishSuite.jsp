...
<div id="screen" class="page-content">
	...
	<input type="hidden" name="suite.id" value="<s:property value='suite.id' />" />
	  <div class="form-elem Manager_style">
	  		<span class="title_name">添加流量池</span>
			  <ul class="sendMsg clearfix">
					<li>
						<label class="label_name"> 名称：</label>
						<input type="text" style="margin-left:0px;" name="suite.name" value="<s:property value='suite.name' />" id="suiteId" required required-msg="名称不能为空！" />
					 </li>
					 <li>
						<label class="label_name"> 展示名称：</label>
						<input type="text" style="margin-left:0px;" name="suite.alias" value="<s:property value='suite.alias' />" id="alias" required required-msg="展示名称不能为空！" />
					 </li>
					 <li>
						<label class="label_name"> 流量值：</label>
						<input type="text" style="margin-left:0px;" name="suite.amount" value="<s:property value='suite.amount' />" id="amount" required number="true" required-msg="流量值不能为空！" number-msg="请填写数字" />M
					 </li>
					 <li>
					 ...
					 <li>
						...
						<input type="text" style="margin-left:0px;" name="suite.validate" value="<s:property value='suite.validate' />"  required number="true" required-msg="有效期不能为空！" number-msg="请填写数字" />天
					 </li>
					 <li>
						<label class="label_name"> 价格：</label>
						<input type="text" style="margin-left:0px;" name="suite.money" value="<s:property value='suite.money' />"  required number="true" required-msg="价格不能为空！" number-msg="请填写数字" />元
					 </li>
					 <li>
						<label class="label_name"> 月底清零：</label>
