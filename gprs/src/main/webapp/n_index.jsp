				...
				<ul class="layui-nav layui-nav-tree" lay-filter="demo">
					...
					<li class="layui-nav-item"><a href="javascript:;"  ><i class="layui-icon" style="font-size: 20px; margin-right: 10px; ">&#xe617;</i>流量包管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('101','流量包管理','view/admin/package/packageList.jsp')">流量包列表</a>
							</dd>
							<!-- <dd>
								<a href="javascript:;" onclick="tab.add('102','添加流量包','admin/editPackage.action')">添加流量包</a>
							</dd> -->
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px; margin-right: 10px; ">&#xe609;</i>通道管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('201','通道管理','view/admin/channel/channelList.jsp')">通道管理</a>
							</dd>
							<!-- <dd>
								<a href="javascript:;" onclick="tab.add('202','添加新通道','view/admin/channel/addChannel.jsp')">添加新通道</a>
							</dd> -->
							<dd>
								<a href="javascript:;" onclick="tab.add('203','通道模板列表','view/admin/channel/channelTemplate.jsp')">通道模板列表</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px; margin-right: 10px;">&#xe63b;</i>业务管理</a>
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="javascript:;" onclick="tab.add('303','充值卡管理')">充值卡管理</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px; margin-right: 10px;">&#xe63c;</i>订单管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('401','流量充值记录','view/admin/chargeOrderList.jsp')">流量充值记录</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('402','流量缓存记录','view/admin/chargeOrderCacheList.jsp')">流量缓存记录</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('403','消费明细查询','view/admin/ordermanage/paylog.jsp')">消费明细查询</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('404','财务管理','view/admin/ordermanage/agentChargeList.jsp')">财务管理</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px;margin-right: 10px; ">&#xe60c;</i>费用管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('501','报价管理')">报价管理</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('502','流量池管理')">流量池管理</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px; margin-right: 10px;">&#xe612;</i>代理商管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('601','代理商管理', 'view/admin/agentmanage/agentList.jsp')">代理商管理</a>
							</dd>
							<!-- <dd>
								<a href="javascript:;" onclick="tab.add('602','添加代理商','view/admin/agentmanage/addAgent.jsp')">添加代理商</a>
							</dd> -->
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px;margin-right: 10px; ">&#xe649;</i>统计管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('701','统计报表')">统计报表</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('702','区域报表')">区域报表</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px; margin-right: 10px;">&#xe64c;</i>网页管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('801','页面设置')">页面设置</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('802','广告管理')">广告管理</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('803','支付宝充值')">支付宝充值</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px;margin-right: 10px; ">&#xe614;</i>系统管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('901','我的价格')">我的价格</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('902','我的流量池')">我的流量池</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('903','参数设置')">参数设置</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('904','修改密码')">修改密码</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;"><i class="layui-icon" style="font-size: 20px;margin-right: 10px; ">&#xe60e;</i>日志管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" onclick="tab.add('1001','通道提交日志','view/admin/log/channellog.jsp')">通道提交日志</a>
							</dd>
							<dd>
								<a href="javascript:;" onclick="tab.add('1002','回调日志','view/admin/log/callbacklog.jsp')">回调日志</a>
							</dd>
						</dl></li>
				</ul>
			</div>
