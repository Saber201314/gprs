jQuery.fn.fancyZoom = function (options) {
	...
	function show(e) {
		...
		var width = (zoom_width || width * 0.8);
		var height = (zoom_height || height);
		var imgHeight = content_div.height() * width / content_div.width();
		if (imgHeight > height) {
		...
		if (options.scaleImg) {
			zoom_content.html("<img src='" + content_div.attr("src") + "'/>");
