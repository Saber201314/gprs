...
<div id="screen" class="page-content">
	...
	<input type="hidden" name="user.feature" value="<s:property value='user.feature' />" />
	  <div class="upload">
	  		<s:if test="user.compatible == 1">
				<div style="float:right;"><input class="btn btn-info" type="button" id="generateKey" value="生成密钥"></div>	
			</s:if>
			<s:else>
				<div style="float:right; display:none;"><input class="btn btn-info" type="button" id="generateKey" value="生成密钥"></div>	
			</s:else>
	  		<br/>
	  		<br/>	  						  		
	  		<dl>	  		
			  ...
			  <ul class="Add_Manager_style">
				<li>
				 ...
				 <li>
					...
					<s:select type="text" name="user.paperId" list="paperList" listKey="id" listValue="name" theme="simple"></s:select>
				 </li>
				 <li>
