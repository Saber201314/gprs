...
<script
	src="${pageContext.request.contextPath}/resourse/assets/js/ace-extra.min.js"></script>
...
<div class="navbar navbar-default" id="navbar">
	...
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-right" role="navigation">
			<div class="get_time">
				<span>欢迎光临, <label style="color:blue;margin-top:-3px;">${session.user.username }</label></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="time"></span>
			</div>
			<ul class="nav ace-nav">
				<li><a href="javascript:void(0)" class="change_Password">修改密码</a></li>
				<li><a href="javascript:void(0)" id="Exit_system">退出系统</a></li>
				<li><label style="font-size:12px;color:#ffffff;padding-right:10px;">当前代理商余额：
							<label style="color:red;margin-top:-3px;">${session.user.moneyString }</label>元</label></li>
			</ul>
			<!-- /.ace-nav -->
		</div>
		<!-- /.navbar-header -->
	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list" id="nav_list">
				<li class="home"><a href="javascript:void(0)" name="../report/chargeReportList.action"
				...
				<li><a href="#" class="dropdown-toggle"><i
					...
					<ul class="submenu">
						...
						<li class="home"><a href="javascript:void(0)"
							name="../query/agentPriceList.action" title="我的报价查询" class="iframeurl"><i
								class="icon-double-angle-right"></i>我的报价查询</a></li>
						<li class="home"><a href="javascript:void(0)"
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
			 ...
			 <iframe id="iframe"
				...
				src="../report/chargeReportList.action"> </iframe> 
		...
		<div class="ace-settings-container" id="ace-settings-container">
			<div class="btn btn-app btn-xs btn-warning ace-settings-btn" style="height:40px;margin-top:20px;"
				id="ace-settings-btn">
				<i class="icon-cog bigger-150"></i>
			</div>

			<div class="ace-settings-box" id="ace-settings-box" style="margin-top:20px;">
				<div>
					<div class="pull-left">
...
<script type="text/javascript">	
function goHome(){	
	$("#iframe").attr("src","../report/chargeReportList.action");
	$(".Current_page").text("");
}
	 
//初始化宽度、高度    
$("#main-container").height($(window).height()-176); 
$("#iframe").height($(window).height()-160); 
$(".sidebar").height($(window).height()-99); 
var thisHeight = $("#nav_list").height($(window).height()-180); 
...
$(".submenu").height($(thisHeight).height()-360);
$("#nav_list").children(".submenu").css("height",thisHeight);
 });
